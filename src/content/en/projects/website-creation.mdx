...
importance: 5
relatedReferences: ['nextjs', 'react', 'typescript']
---
...
Tailwind CSS · Radix UI · shadcn/ui · Lucide · Framer Motion

### Content and i18n

MDX · next-mdx-remote · gray-matter · next-intl

### Math, code, and visualization

KaTeX · react-syntax-highlighter · Recharts
...
The site is open source on GitHub: [khonen-git/siteperso](https://github.com/khonen-git/siteperso)
