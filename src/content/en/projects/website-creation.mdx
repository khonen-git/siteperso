...
description: 'Developing a professional website to showcase my projects and skills'
...
Ce projet est un élément central de mon parcours. Qu’il serve de CV en ligne, de vitrine pour mes projets, de synthèse de mes connaissances ou même de bibliothèque de références, ce site web représente une base stable pour tout ce que je construis. Il m'accompagnera sur le long terme, évoluant au fil de mes compétences et de mes besoins. {/* Ajouter quelques lignes importantes du résumé */}
...
C’est pourquoi j’ai adopté une méthode hybride : rédaction d’un cahier des charges (CDC.md), transformation assistée en plan de développement (DEVBOOK.md), puis développement progressif avec validation manuelle et refactoring régulier.
...
<TechnologiesSection>
  <Technology
    name="TypeScript"
    description="Langage de programmation typé qui ajoute des types statiques à JavaScript, améliorant la maintenabilité et la robustesse du code"
  />
  <Technology
    name="Javascript"
    description="Langage de programmation principal utilisé pour le développement frontend et les interactions côté client"
  />
</TechnologiesSection>
...
<TechnologiesSection>
  <Technology
    name="Next.js"
    description="Framework React qui offre le rendu côté serveur, le routage et l'optimisation des performances"
  />
  <Technology
    name="React"
    description="Bibliothèque JavaScript pour la construction d'interfaces utilisateur interactives et réactives"
  />
</TechnologiesSection>
...
<TechnologiesSection>
  <Technology
    name="Tailwind CSS"
    description="Framework CSS utilitaire pour construire des interfaces modernes et responsives"
  />
  <Technology
    name="shadcn/ui"
    description="Collection de composants UI réutilisables et personnalisables"
  />
</TechnologiesSection>
...
<TechnologiesSection>
  <Technology
    name="Zustand"
    description="Bibliothèque légère de gestion d'état pour React, offrant une API simple et intuitive"
  />
</TechnologiesSection>
...
<TechnologiesSection>
  <Technology
    name="ESLint"
    description="Outil d'analyse de code statique pour identifier et corriger les problèmes de code"
  />
  <Technology
    name="Prettier"
    description="Formateur de code pour maintenir un style de code cohérent"
  />
  <Technology
    name="Jest"
    description="Framework de test pour JavaScript, utilisé pour les tests unitaires et d'intégration"
  />
</TechnologiesSection>
...
<TechnologiesSection>
  <Technology
    name="MDX"
    description="Format qui permet d'écrire du JSX dans des documents Markdown"
  />
  <Technology
    name="KaTeX"
    description="Bibliothèque pour le rendu de formules mathématiques dans le navigateur"
  />
...
<TechnologiesSection>
  ...
  <Technology
    name="PostCSS"
    description="Outil de transformation CSS avec un écosystème de plugins"
  />
  <Technology
    name="Autoprefixer"
    description="Plugin PostCSS pour ajouter automatiquement les préfixes vendeurs CSS"
  />
</TechnologiesSection>
...
<TechnologiesSection>
  <Technology
    name="Vercel"
    description="Plateforme de déploiement optimisée pour les applications Next.js"
  />
</TechnologiesSection>
...
Le développement de mon site web professionnel assisté par l'IA m'a permis de lancer un premier produit assez rapidement avec seulement quelques bases dans le développement web.

L'IA présente beaucoup d'avantages pour un débutant qui souhaite développer un projet mais a aussi certaines contraintes et limites au fur à et mesure que le projet prenne de l'ampleur : il faut savoir quand l'utiliser et ne pas se reposer uniquement sur celui-ci.

Ce site n’est pas une fin, mais une base. Il évoluera avec mes compétences, et servira de support pour mes futurs projets.
...
- Créer un projet web avec Next.js
- Structurer des pages dynamiques avec MDX
- Intégrer des composants UI

### Git

- Gestion d'un projet avec Git

### Développement assisté par l'IA

- Toujours vérifier le résultat du code par l'IA.
- Utiliser un cahier des charges et un plan de développement écrit
- Toujours avoir la possibilité de revenir en arrière avec un versionning du code au cas où les erreurs de l'IA causerait des bugs ou l'IA hallucinerait en bouclant sans cesse.
