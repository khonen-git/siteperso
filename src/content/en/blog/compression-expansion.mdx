...
Under **N_C** null (compression + <MathInline>{"D_{\\mathrm{pre}}"}</MathInline> controlled): Δ MFE50 H=10 ≈ **+0.06** only — no exploitable edge even with tight matching.
...
- <Link href="/knowledge/quantitative-finance/volatility/implied-vs-realized">Realized vs implied volatility</Link>
