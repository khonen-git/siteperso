...
évoluant au fil de mes compétences et de mes besoins.
...
<TechnologiesSection>
  ...
  <Technology name="Digital Ocean" description="Fournisseur de cloud computing pour l'hébergement des applications" />
</TechnologiesSection>

## Résultats

Le site est en open source sur mon GitHub : {/* Lien github */}
