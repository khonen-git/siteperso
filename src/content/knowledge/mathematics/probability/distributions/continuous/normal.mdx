...
<MdxCard>
  <div className="space-y-2">
    <p>• Rice, John A. (2006). Mathematical Statistics and Data Analysis</p>
    <p>• Wasserman, Larry (2004). All of Statistics: A Concise Course in Statistical Inference</p>
    <p>• Documentation SciPy : scipy.stats.norm</p>
  </div>
</MdxCard> 