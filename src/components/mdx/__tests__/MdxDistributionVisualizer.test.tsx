...
describe('MdxDistributionVisualizer', () => {
  ...
  it('applies base wrapper classes', () => {
    const { container } = render(<MdxDistributionVisualizer distribution={normalDistribution} />);
  ...
  it('applies preset container classes', () => {
    ...
    expect(presetContainer).toHaveClass('mt-4', 'p-4', 'border', 'rounded-lg', 'bg-gray-50');
  });

  describe('Hydration', () => {
    it('keeps state across rerenders', () => {
      const { rerender } = render(<MdxDistributionVisualizer distribution={normalDistribution} />);
  ...
  describe('Performance', () => {
    ...
    it('handles updates efficiently', () => {
      ...
      rerender(<MdxDistributionVisualizer distribution={normalDistribution} showPresets={true} />);
